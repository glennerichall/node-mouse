...
export async function createServicesContainer({
    ...
    let container = {
        ...
        getSecurity: createLazy(() => createSecurityService(container)),
        getAuthorization: createLazy(() => createAuthorizationService(container)),
        getDeviceSessionService: createLazy(() => createDeviceSessionService(container)),
